  ...
  if (sessions.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-96 gap-4">
        ...
        <p className="text-zinc-500">Carga un informe de conciliación SFTR para comenzar.</p>
        <Link to="/upload">
          <Button>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-zinc-500 mt-1">Resumen de todas las sesiones de conciliación</p>
        </div>
        <Link to="/upload">
          <Button>
            <Upload className="h-4 w-4 mr-2" />
