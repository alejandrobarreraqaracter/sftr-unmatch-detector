...
LLM_USAGE_WINDOW_HOURS = int(os.getenv("LLM_USAGE_WINDOW_HOURS", "4"))
LLM_USAGE_TOKEN_LIMIT_PER_WINDOW = int(os.getenv("LLM_USAGE_TOKEN_LIMIT_PER_WINDOW", "50000"))
LLM_USAGE_WARNING_RATIO = float(os.getenv("LLM_USAGE_WARNING_RATIO", "0.75"))
